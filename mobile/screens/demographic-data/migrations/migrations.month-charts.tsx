    ...
    return (
        <View style={[ styles.container, { backgroundColor: Colors[ colorScheme ].background, } ]}>
            ...
            <View style={nav == 'Males' ? style.chartContainer : { position: 'absolute', left: -500 }}>
                <Text style={[ style.chartTitle, { color: Colors[ colorScheme ].text } ]}>Male Migrations on Year ({props.data.year})</Text>
            ...
            <View style={nav == 'Females' ? style.chartContainer : { position: 'absolute', left: -500 }}>
                <Text style={[ style.chartTitle, { color: Colors[ colorScheme ].text } ]}>Female Migrations on Year ({props.data.year})</Text>
            ...
            <View style={nav == 'Total' ? style.chartContainer : { position: 'absolute', left: -500 }}>
                <Text style={[ style.chartTitle, { color: Colors[ colorScheme ].text } ]}>Total Migrations on Year ({props.data.year})</Text>
